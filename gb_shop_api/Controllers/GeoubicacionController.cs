...
namespace gb_shop_api.Controllers
{
    ...
    [ApiController]
    public class GeoubicacionController : ControllerBase
    {
        GeoubicacionRepository repository = new GeoubicacionRepository();
        ...
        [HttpPost]
        //Agregar usuario
        public IActionResult Add(GeoubicacionRequest model)
        {
        ...
        public IActionResult Edit(GeoubicacionRequest model)
        {
