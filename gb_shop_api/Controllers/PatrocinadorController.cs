...
namespace gb_shop_api.Controllers
{
    ...
    {
        PatrocinadorRepository repository = new PatrocinadorRepository();
        ...
        [HttpPost]
        //Agregar usuario
        public IActionResult Add(PatrocinadorRequest model)
        {
        ...
        public IActionResult Edit(PatrocinadorRequest model)
        {
