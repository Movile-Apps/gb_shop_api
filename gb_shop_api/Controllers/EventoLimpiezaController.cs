...
namespace gb_shop_api.Controllers
{
    ...
    [ApiController]
    public class EventoLimpiezaController : ControllerBase
    {
        EventoLimpiezaRepository repository = new EventoLimpiezaRepository();
        ...
        [HttpPost]
        //Agregar usuario
        public IActionResult Add(EventoLimpiezaRequest model)
        {
        ...
        public IActionResult Edit(EventoLimpiezaRequest model)
        {
